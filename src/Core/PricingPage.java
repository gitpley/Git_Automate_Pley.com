...
public class PricingPage extends BaseClass{
	...
	public void selectPlan_Inclusive() throws InterruptedException{
		driver.get("https://stage.pley.com/pricing");
		driver.manage().window().maximize();
		driver.findElement(By.xpath(TestCore.object.getProperty("Inclusive"))).click();
		Thread.sleep(3000);
	...
	public void verifySignup() throws InterruptedException{
		WebElement v = driver.findElement(By.xpath(TestCore.object.getProperty("verification5")));
		String s = v.getText();
